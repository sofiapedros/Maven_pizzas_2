...
def calcular_ingredientes(order_pizzas, pizza_types):
    ...
    ingredientes = pd.DataFrame(columns = ['Ingredient','Number of rations needed'])
            ...
            if len(ingredientes) == 0:
                ...
                for j in range(len(ingredientes)):
                    ...
                    if re.search(ingrediente,str(fila2)):
                        ...
                        anterior = fila2['Number of rations needed']
                        nuevo = anterior + order_pizzas.loc[i,'numero']
                        ingredientes.loc[j,'Number of rations needed'] = nuevo
                        añadido = True
                        break
                if añadido == False:
